...
def test_planar_trajectory_1():
    traj = PlanarTrajectory(controls_rs, 2, 2, 4, [3, 5, 1, 4, 1, 5, 1, 5, 1, 4, 5, 1, 4, 5, 3, 2, 0, 2, 3], [1, 2, 1, 1, 1, 1, 1, 1, 4, 1, 1, 1, 2, 2, 1, 1, 5, 1, 1])
    ...
    for i in range(len(traj.sequence)):
        x, y, theta = traj.config_at_t(i)
        print("Move:", traj.controls[traj.sequence[i]])
        print(f'x: {x},   y: {y},   theta: {theta}')
